...
def draw_all(ex, ey, mx, my, earthframe, moonframe):
        clear_canvas()
...
def orbit_move(earthframe, moonframe):
    ...
    for deg in range(-90, 270, 5):
        ...
        draw_all(ex,ey,mx,my,earthframe, moonframe)
...
while(1):
    orbit_move(earthframe, moonframe)
    get_events()
